...
<body id="kt_body" class="header-fixed header-tablet-and-mobile-fixed toolbar-enabled toolbar-fixed aside-enabled aside-fixed" style="--kt-toolbar-height:55px;--kt-toolbar-height-tablet-and-mobile:55px">
				...
				<div id="kt_header" class="header align-items-stretch">
					...
					<div id="kt_toolbar_container" class="container-fluid d-flex flex-stack">
						...
						<div data-kt-swapper="true" data-kt-swapper-mode="prepend" data-kt-swapper-parent="{default: '#kt_content_container', 'lg': '#kt_toolbar_container'}" class="page-title d-flex align-items-center flex-wrap me-3 mb-5 mb-lg-0">
							<!--begin::Title-->
							<h1 class="d-flex align-items-center text-dark fw-bolder fs-3 my-1">Plates of Menu</h1>
							<!--end::Title-->
							<!--begin::Separator-->
							...
							<ul class="breadcrumb breadcrumb-separatorless fw-bold fs-7 my-1">
								...
								<!--begin::Item-->
								<li class="breadcrumb-item text-muted">
									<a href="<?= base_url('menus') ?>" class="text-muted text-hover-primary">Menus</a>
								</li>
								<!--end::Item-->
											...
											<div class="menu menu-sub menu-sub-dropdown w-300px w-md-325px" data-kt-menu="true" id="kt-toolbar-filter">
												...
												<form action="<?= base_url('menu_plates/' . esc($menu['id'])) ?>" method="get" class="px-7 py-5">
													...
													<div class="d-flex align-items-center position-relative my-1">
														...
														<input type="text" name="searchParams[amount]" id="searchName" class="form-control form-control-solid w-250px ps-15" placeholder="Amount" value="<?= esc($searchParams['amount'] ?? '') ?>" />
													</div>
													<!--end::Search-->
													...
													<div class="d-flex justify-content-end mt-5">
														<button type="button" onclick="window.location='<?= base_url('menu_plates/' . $menu['id']) ?>'" class="btn btn-light btn-active-light-primary me-2" data-kt-menu-dismiss="true" data-kt-customer-table-filter="reset">Reset</button>
							...
							<div class="modal fade" id="kt_modal_add_customer" tabindex="-1" aria-hidden="true">
								...
								<div class="modal-dialog modal-dialog-centered mw-650px">
									...
									<div class="modal-content">
										...
										<!--begin::Form-->
										<form class="form" id="kt_modal_add_customer_form" data-id-menu="<?= $menu['id'] ?>">
											<!--begin::Modal header-->
																		...
																		<div class="card border-primary h-100">
																			<div class="card-body p-2">
																				<div class="d-flex align-items-center">
																					<input class="form-check-input me-2 select-plate" type="checkbox" value="<?= $plate['id'] ?>" data-id="<?= $plate['id'] ?>">
																					<label style="text-overflow: ellipsis; overflow: hidden; white-space: nowrap;" class="form-check-label" for="plate_<?= $plate['id'] ?>"><?= $plate['name'] ?></label>
																				</div>
																				<div class="mt-2 d-flex align-items-center justify-content-between">
																					<div>
																						<span class="badge bg-primary"><?= $plate['price'] ?> $</span>
																						<span class="badge bg-primary ms-2"><?= $plate['category'] ?></span>

																					</div>


																					<div class="d-flex align-items-center ms-3" data-id-plate="<?= $plate['id'] ?>">
																						<button type="button" class="decrement-btn btn btn-sm btn-outline-secondary p-1" data-id="<?= $plate['id'] ?>">-</button>
																						<span class="count mx-2 text-decoration-line-through">0</span>
																						<button type="button" class="increment-btn btn btn-sm btn-outline-secondary p-1" data-id="<?= $plate['id'] ?>">+</button>
																					</div>
																				</div>
	...
	<script src="../assets/js/custom/apps/customers/add/addPlatesToMenu.js"></script>
