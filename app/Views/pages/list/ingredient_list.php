...
<body id="kt_body" class="header-fixed header-tablet-and-mobile-fixed toolbar-enabled toolbar-fixed aside-enabled aside-fixed" style="--kt-toolbar-height:55px;--kt-toolbar-height-tablet-and-mobile:55px">
				...
				<div id="kt_header" class="header align-items-stretch">
					...
					<div id="kt_toolbar_container" class="container-fluid d-flex flex-stack">
						...
						<div data-kt-swapper="true" data-kt-swapper-mode="prepend" data-kt-swapper-parent="{default: '#kt_content_container', 'lg': '#kt_toolbar_container'}" class="page-title d-flex align-items-center flex-wrap me-3 mb-5 mb-lg-0">
							<!--begin::Title-->
							<h1 class="d-flex align-items-center text-dark fw-bolder fs-3 my-1">Ingredients List</h1>
							<!--end::Title-->
							<!--begin::Separator-->
							...
							<ul class="breadcrumb breadcrumb-separatorless fw-bold fs-7 my-1">
								...
								<!--end::Item-->
								<!--begin::Item-->
								<li class="breadcrumb-item text-dark">ingredients list</li>
								<!--end::Item-->
							</ul>
							<!--end::Breadcrumb-->
						</div>
									...
									<div class="card-toolbar">
										...
										<div class="d-flex justify-content-end" data-kt-customer-table-toolbar="base">
											...
											<div class="menu menu-sub menu-sub-dropdown w-300px w-md-325px" data-kt-menu="true" id="kt-toolbar-filter">
												...
												<form action="<?= base_url('ingredients') ?>" method="get" class="px-7 py-5">
											...
											<!--begin::Add customer-->
											<button type="button" class="btn btn-primary" data-bs-toggle="modal" data-bs-target="#kt_modal_add_customer">Add Ingredients</button>
											<!--end::Add customer-->
										</div>
										<!--end::Toolbar-->
										<!--begin::Group actions-->
												...
												<?php else: ?>
													<?php foreach ($ingredients as $ingredient): ?>
														<tr>
															...
															<td>
																<?php if (empty($ingredient['expiration_date'])): ?>
																	<span>No expiration date</span>
																<?php else: ?>
																	<span><?= esc(date('d/m/Y', strtotime($ingredient['expiration_date']))) ?></span>
																<?php endif; ?>
															</td>
															...
															<td class="text-end actions" data-id="<?= esc($ingredient['id']) ?>">
																...
																<div class="menu menu-sub menu-sub-dropdown menu-column menu-rounded menu-gray-600 menu-state-bg-light-primary fw-bold fs-7 w-125px py-4" data-kt-menu="true">
																	...
																	<?php if (empty($ingredient['disabled'])): ?>
									...
									<div class="modal-content">
										...
										<form class="form" action="#" id="kt_modal_add_customer_form">
											...
											<div class="modal-header" id="kt_modal_add_customer_header">
												<!--begin::Modal title-->
												<h2 class="fw-bolder">Add a Ingredient</h2>
												<!--end::Modal title-->
												<!--begin::Close-->
											...
											<div class="modal-body py-10 px-lg-17">
												...
												<div class="scroll-y me-n7 pe-7" id="kt_modal_add_customer_scroll" data-kt-scroll="true" data-kt-scroll-activate="{default: false, lg: true}" data-kt-scroll-max-height="auto" data-kt-scroll-dependencies="#kt_modal_add_customer_header" data-kt-scroll-wrappers="#kt_modal_add_customer_scroll" data-kt-scroll-offset="300px">
													...
													<div class="fv-row mb-7">
														<!--begin::Label-->
														<label class="fw-bold fs-6 mb-2">Allergens</label>
														<!--end::Label-->

														<!--begin::Input-->
														<input class="form-control form-control-solid" name="allergens" value="" id="kt_tagify" />
														<!--end::Input-->
													</div>
													...
													<div class="row g-9 mb-7">
														...
														<div class="col-md-7 fv-row">
															<label class="required fs-6 fw-bold mb-2">Quantity Available</label>

															<!--begin::Input-->
															<div class="d-flex gap-3">
																<input class="form-control form-control-solid" name="quantityAvailabe" type="number" min="1" />
															</div>
															<!--end::Input-->
														</div>
														<!--end::Col-->
														...
														<div class="col-md-5 fv-row">
															<!--begin::Label-->
															<label class="required fs-6 fw-bold mb-2">Unit of Measurement</label>
															<!--end::Label-->

															<!--begin::Input-->
															<div class="d-flex gap-3">
																<select class="form-select form-select-solid fw-bolder" name="measure" aria-label="Select a Unit" data-control="select2" data-placeholder="Select a Unit..." data-dropdown-parent="#kt_modal_add_customer">
																	<option value=""></option>
																	<option value="g">g --- Grams</option>
																	<option value="kg">kg --- Kilograms</option>
																	<option value="oz">oz --- Ounces</option>
																	<option value="lb">lb --- Pounds</option>
																	<option value="cda">cda --- Tablespoon</option>
													...
													<div class="row g-9 mb-7">
														...
														<div class="col-md-6 fv-row">
															...
															<label class="fw-bold fs-6 mb-2">
																...
																<i class="fas fa-exclamation-circle ms-1 fs-7" data-bs-toggle="tooltip" title="If no date is selected, it will be marked as not expiring"></i>
															</label>
															<!--end::Label-->
	...
	<script src="./assets/js/custom/apps/customers/add/addIngredients.js"></script>
