											...
											<div class="menu menu-sub menu-sub-dropdown w-300px w-md-325px" data-kt-menu="true" id="kt-toolbar-filter">
												...
												<form action="<?= base_url('ingredients') ?>" method="get" class="px-7 py-5">
													...
													<div class="d-flex align-items-center position-relative my-1">
														...
														<input type="text" name="searchParams[quantity_available]" id="searchName" class="form-control form-control-solid w-250px ps-15" placeholder="Cantidad Disponible" value="<?= esc($searchParams['quantity_available'] ?? '') ?>" />
													</div>
													<!--end::Search-->
													...
													<div class="d-flex align-items-center position-relative my-1">
														...
														<input type="text" name="searchParams[expiration_date]" id="searchName" class="form-control form-control-solid w-250px ps-15" placeholder="Fecha de caducidad" value="<?= esc($searchParams['expiration_date'] ?? '') ?>" />
													</div>
													<!--end::Search-->
													...
													<div class="d-flex align-items-center position-relative my-1">
														...
														<input type="text" name="searchParams[allergens]" id="searchName" class="form-control form-control-solid w-250px ps-15" placeholder="Alérgenos" value="<?= esc($searchParams['allergens'] ?? '') ?>" />
													</div>
													<!--end::Search-->
											...
											<tbody class="fw-bold text-gray-600">
												<?php foreach ($ingredients as $ingredient): ?>
													...
													<tr>
														...
														<td>
														<?= esc(date('d-m-Y', strtotime($ingredient['expiration_date']))) ?>
														</td>
