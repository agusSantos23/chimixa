								...
								<div class="card-body pt-9 pb-0">
												...
												<div class="d-flex my-4">
													...
													<div class="me-0">
														...
														<div class="menu menu-sub menu-sub-dropdown menu-column menu-rounded menu-gray-800 menu-state-bg-light-primary fw-bold w-200px py-3" data-kt-menu="true">
															...
															<!--begin::Menu item-->
															<div class="menu-item px-3">
																<a href="<?= base_url('profile/logout') ?>" class="menu-link px-3">Log Out</a>
															</div>
															<!--end::Menu item-->
									...
									<div class="d-flex overflow-auto h-55px">
										<ul class="nav nav-stretch nav-line-tabs nav-line-tabs-2x border-transparent fs-5 fw-bolder flex-nowrap">
											<!--begin::Nav item-->
											<li class="nav-item">
												<a class="nav-link text-active-primary me-6 <?= (isset($_GET['isEditing']) && $_GET['isEditing'] == 'false') ? 'active' : '' ?>" href="<?= base_url('profile?isEditing=false') ?>">Overview</a>
											</li>
											<!--end::Nav item-->
											<!--begin::Nav item-->
											<li class="nav-item">
												<a class="nav-link text-active-primary me-6 <?= (isset($_GET['isEditing']) && $_GET['isEditing'] == 'true') ? 'active' : '' ?>" href="<?= base_url('profile?isEditing=true') ?>">Settings</a>
											</li>
											<!--end::Nav item-->
										</ul>
									</div>
